...
const GOLD_SILVER_ROUTES: GameLocation[] = [
  ...
  // Pre-Elite Four
  { key: 'boss-rival-goldenrod-underground', name: 'Rival (Goldenrod Underground)', segment: 'Pre-Clair' },
  ...
  { key: 'boss-rocket-proton', name: 'Rocket Executive Proton', segment: 'Pre-Jasmine' },
  { key: 'boss-rocket-petrel', name: 'Rocket Executive Petrel', segment: 'Pre-Clair' },
  { key: 'boss-rocket-ariana', name: 'Rocket Executive Ariana', segment: 'Pre-Clair' },
  { key: 'mt-silver', name: 'Mt. Silver', segment: 'Post-Game' },
  { key: 'boss-red-mt-silver', name: 'Red (Mt. Silver)', segment: 'Post-Game' },
];
...
const RUBY_SAPPHIRE_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-maxie-mt-chimney-ruby', name: 'Maxie (Mt. Chimney - Ruby)', segment: 'Pre-Flannery' },
  { key: 'boss-archie-mt-chimney-sapphire', name: 'Archie (Mt. Chimney - Sapphire)', segment: 'Pre-Flannery' },
  ...
  { key: 'boss-maxie-seafloor', name: 'Maxie (Seafloor Cavern - Ruby)', segment: 'Pre-Wallace' },
  { key: 'boss-archie-seafloor', name: 'Archie (Seafloor Cavern - Sapphire)', segment: 'Pre-Wallace' },
  { key: 'victory-road-rs', name: 'Victory Road', segment: 'Pre-Wallace' },
  { key: 'boss-wallace', name: 'Wallace', segment: 'Pre-Wallace' },
  // Pre-Elite Four
  { key: 'boss-wally-victory-road', name: 'Wally (Victory Road)', segment: 'Pre-Elite Four' },
...
const EMERALD_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-maxie-mt-chimney', name: 'Maxie (Mt. Chimney)', segment: 'Pre-Flannery' },
  { key: 'boss-flannery', name: 'Flannery', segment: 'Pre-Flannery' },
  // Pre-Norman
  ...
  { key: 'boss-archie-seafloor', name: 'Archie (Seafloor Cavern)', segment: 'Pre-Juan' },
  { key: 'boss-maxie-magma-hideout', name: 'Maxie (Magma Hideout)', segment: 'Pre-Juan' },
...
const DIAMOND_PEARL_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-barry-lake-verity', name: 'Barry (Lake Verity)', segment: 'Pre-Roark' },
  { key: 'boss-barry-route-203', name: 'Barry (Route 203)', segment: 'Pre-Roark' },
  ...
  { key: 'boss-mars-valley-windworks', name: 'Mars (Valley Windworks)', segment: 'Pre-Gardenia' },
  { key: 'boss-jupiter-eterna-building', name: 'Jupiter (Eterna Building)', segment: 'Pre-Gardenia' },
  ...
  { key: 'boss-barry-hearthome-city', name: 'Barry (Hearthome City)', segment: 'Pre-Maylene' },
  ...
  { key: 'boss-barry-canalave-city', name: 'Barry (Canalave City)', segment: 'Pre-Byron' },
  ...
  { key: 'boss-saturn-lake-valor', name: 'Saturn (Lake Valor)', segment: 'Pre-Candice' },
  { key: 'boss-jupiter-lake-acuity', name: 'Jupiter (Lake Acuity)', segment: 'Pre-Candice' },
  ...
  { key: 'boss-mars-lake-verity', name: 'Mars (Lake Verity)', segment: 'Pre-Volkner' },
  { key: 'boss-cyrus-galactic-hq', name: 'Cyrus (Galactic HQ)', segment: 'Pre-Volkner' },
  ...
  { key: 'boss-cyrus-spear-pillar', name: 'Cyrus (Spear Pillar)', segment: 'Pre-Elite Four' },
  { key: 'boss-barry-route-224', name: 'Barry (Route 224)', segment: 'Pre-Elite Four' },
...
const PLATINUM_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-cyrus-distortion-world', name: 'Cyrus (Distortion World)', segment: 'Pre-Elite Four' },
  { key: 'boss-barry-route-224', name: 'Barry (Route 224)', segment: 'Pre-Elite Four' },
  { key: 'boss-elite-four-aaron', name: 'Elite Four: Aaron', segment: 'Pre-Elite Four' },
  { key: 'boss-elite-four-bertha', name: 'Elite Four: Bertha', segment: 'Pre-Elite Four' },
  { key: 'boss-elite-four-flint', name: 'Elite Four: Flint', segment: 'Pre-Elite Four' },
...
const HEARTGOLD_SOULSILVER_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-silver-cherrygrove', name: 'Silver (Cherrygrove City)', segment: 'Pre-Falkner' },
  { key: 'boss-falkner', name: 'Falkner', segment: 'Pre-Falkner' },
  // Pre-Bugsy
  ...
  { key: 'boss-proton-slowpoke-well', name: 'Proton (Slowpoke Well)', segment: 'Pre-Bugsy' },
  { key: 'boss-silver-azalea', name: 'Silver (Azalea Town)', segment: 'Pre-Bugsy' },
  { key: 'boss-bugsy', name: 'Bugsy', segment: 'Pre-Bugsy' },
  // Pre-Whitney
  ...
  { key: 'boss-silver-burned-tower', name: 'Silver (Burned Tower)', segment: 'Pre-Morty' },
  { key: 'boss-morty', name: 'Morty', segment: 'Pre-Morty' },
  // Pre-Chuck
  { key: 'hgss-route-40', name: 'Route 40', segment: 'Pre-Chuck' },
  { key: 'hgss-route-41', name: 'Route 41', segment: 'Pre-Chuck' },
  { key: 'boss-chuck', name: 'Chuck', segment: 'Pre-Chuck' },
  { key: 'boss-silver-cianwood', name: 'Silver (Cianwood City)', segment: 'Pre-Chuck' },
  // Pre-Jasmine
  ...
  { key: 'boss-petrel-radio-tower', name: 'Petrel (Goldenrod Radio Tower)', segment: 'Pre-Pryce' },
  { key: 'boss-proton-radio-tower', name: 'Proton (Goldenrod Radio Tower)', segment: 'Pre-Pryce' },
  { key: 'boss-ariana-radio-tower', name: 'Ariana (Goldenrod Radio Tower)', segment: 'Pre-Pryce' },
  { key: 'boss-archer-radio-tower', name: 'Archer (Goldenrod Radio Tower)', segment: 'Pre-Pryce' },
  { key: 'boss-pryce', name: 'Pryce', segment: 'Pre-Pryce' },
  // Pre-Clair
  ...
  { key: 'boss-silver-victory-road', name: 'Silver (Victory Road)', segment: 'Pre-Clair' },
  { key: 'boss-clair', name: 'Clair', segment: 'Pre-Clair' },
  // Pre-Elite Four
  { key: 'boss-elite-four-will', name: 'Elite Four: Will', segment: 'Pre-Elite Four' },
  { key: 'boss-elite-four-koga', name: 'Elite Four: Koga', segment: 'Pre-Elite Four' },
  ...
  { key: 'boss-elite-four-karen', name: 'Elite Four: Karen', segment: 'Pre-Elite Four' },
  { key: 'boss-lance-champion', name: 'Lance (Champion)', segment: 'Pre-Elite Four' },
  { key: 'boss-red-mt-silver', name: 'Red (Mt. Silver)', segment: 'Pre-Elite Four' },
];
...
const BLACK_WHITE_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-bianca-nuvema', name: 'Bianca (Nuvema Town)', segment: 'Pre-Cilan/Chili/Cress' },
  { key: 'boss-cheren-nuvema', name: 'Cheren (Nuvema Town)', segment: 'Pre-Cilan/Chili/Cress' },
  { key: 'boss-n-accumula', name: 'N (Accumula Town)', segment: 'Pre-Cilan/Chili/Cress' },
  ...
  { key: 'boss-cheren-route3', name: 'Cheren (Route 3)', segment: 'Pre-Lenora' },
  { key: 'boss-bianca-route2', name: 'Bianca (Route 2)', segment: 'Pre-Lenora' },
  { key: 'boss-n-nacrene', name: 'N (Nacrene City)', segment: 'Pre-Lenora' },
  ...
  { key: 'boss-bianca-pinwheel', name: 'Bianca (Pinwheel Forest)', segment: 'Pre-Burgh' },
  ...
  { key: 'boss-bianca-route4', name: 'Bianca (Route 4)', segment: 'Pre-Elesa' },
  { key: 'boss-cheren-route5', name: 'Cheren (Route 5)', segment: 'Pre-Elesa' },
  { key: 'boss-n-nimbasa', name: 'N (Nimbasa City)', segment: 'Pre-Elesa' },
  ...
  { key: 'boss-bianca-driftveil', name: 'Bianca (Driftveil City)', segment: 'Pre-Clay' },
  { key: 'boss-n-chargestone', name: 'N (Chargestone Cave)', segment: 'Pre-Clay' },
  ...
  { key: 'boss-cheren-twist-mountain', name: 'Cheren (Twist Mountain)', segment: 'Pre-Skyla' },
  ...
  { key: 'boss-bianca-route8', name: 'Bianca (Route 8)', segment: 'Pre-Brycen' },
  ...
  { key: 'boss-cheren-route10', name: 'Cheren (Route 10)', segment: 'Pre-Drayden/Iris' },
  ...
  { key: 'boss-ghetsis', name: 'Ghetsis', segment: 'Pre-Elite Four' },
];
...
const BLACK2_WHITE2_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-hugh-floccesy', name: 'Hugh (Floccesy Town)', segment: 'Pre-Cheren' },
  ...
  { key: 'boss-hugh-route4', name: 'Hugh (Route 4)', segment: 'Pre-Burgh' },
  { key: 'boss-colress-route4', name: 'Colress (Route 4)', segment: 'Pre-Burgh' },
  { key: 'boss-burgh', name: 'Burgh', segment: 'Pre-Burgh' },
  // Pre-Elesa
  ...
  { key: 'boss-hugh-driftveil', name: 'Hugh (Driftveil City)', segment: 'Pre-Clay' },
  { key: 'boss-clay', name: 'Clay', segment: 'Pre-Clay' },
  // Pre-Skyla
  ...
  { key: 'boss-hugh-reversal-mountain', name: 'Hugh (Reversal Mountain)', segment: 'Pre-Drayden' },
  { key: 'boss-colress-plasma-frigate', name: 'Colress (Plasma Frigate)', segment: 'Pre-Drayden' },
  ...
  { key: 'boss-hugh-victory-road', name: 'Hugh (Victory Road)', segment: 'Pre-Elite Four' },
  { key: 'boss-n-victory-road', name: 'N (Victory Road)', segment: 'Pre-Elite Four' },
  { key: 'boss-elite-four-shauntal', name: 'Elite Four: Shauntal', segment: 'Pre-Elite Four' },
  { key: 'boss-elite-four-grimsley', name: 'Elite Four: Grimsley', segment: 'Pre-Elite Four' },
  { key: 'boss-elite-four-caitlin', name: 'Elite Four: Caitlin', segment: 'Pre-Elite Four' },
  { key: 'boss-elite-four-marshal', name: 'Elite Four: Marshal', segment: 'Pre-Elite Four' },
...
const X_Y_ROUTES: GameLocation[] = [
  // Pre-Viola
  { key: 'boss-rival-aquacorde-town', name: 'Rival (Aquacorde Town)', segment: 'Pre-Viola' },
  ...
  // Pre-Korrina
  { key: 'boss-rival-route-5', name: 'Rival (Route 5)', segment: 'Pre-Korrina' },
  ...
  // Pre-Olympia
  { key: 'boss-rival-route-14', name: 'Rival (Route 14)', segment: 'Pre-Olympia' },
  ...
  { key: 'boss-lysandre-lysandre-labs', name: 'Lysandre (Lysandre Labs)', segment: 'Pre-Wulfric' },
  { key: 'boss-lysandre-team-flare-hq', name: 'Lysandre (Team Flare HQ)', segment: 'Pre-Wulfric' },
  ...
  { key: 'boss-az-post-champion', name: 'AZ (Post-Champion)', segment: 'Pre-Elite Four' },
];
...
const OMEGA_RUBY_ALPHA_SAPPHIRE_ROUTES: GameLocation[] = [
  ...
  // Pre-Wattson
  { key: 'boss-rival-route-110', name: 'Rival (Route 110)', segment: 'Pre-Wattson' },
  { key: 'boss-wally-mauville-city', name: 'Wally (Mauville City)', segment: 'Pre-Wattson' },
  ...
  { key: 'boss-maxie-mt-chimney-omega-ruby', name: 'Maxie (Mt. Chimney - Omega Ruby)', segment: 'Pre-Flannery' },
  { key: 'boss-archie-mt-chimney-alpha-sapphire', name: 'Archie (Mt. Chimney - Alpha Sapphire)', segment: 'Pre-Flannery' },
  { key: 'boss-flannery', name: 'Flannery', segment: 'Pre-Flannery' },
  // Pre-Norman
  ...
  // Pre-Tate & Liza
  { key: 'boss-rival-lilycove-city', name: 'Rival (Lilycove City)', segment: 'Pre-Tate & Liza' },
  { key: 'boss-maxie-mossdeep-space-center-omega-ruby', name: 'Maxie (Mossdeep - Omega Ruby)', segment: 'Pre-Tate & Liza' },
  { key: 'boss-archie-mossdeep-space-center-alpha-sapphire', name: 'Archie (Mossdeep - Alpha Sapphire)', segment: 'Pre-Tate & Liza' },
...
const SUN_MOON_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-hau-iki-town', name: 'Hau (Iki Town)', segment: 'Pre-Ilima' },
  ...
  { key: 'boss-hau-route-3', name: 'Hau (Route 3)', segment: 'Pre-Ilima' },
  ...
  { key: 'boss-hau-paniola-town', name: 'Hau (Paniola Town)', segment: 'Pre-Lana' },
  ...
  // Pre-Olivia
  { key: 'boss-gladion-route-5', name: 'Gladion (Route 5)', segment: 'Pre-Olivia' },
  ...
  { key: 'boss-guzma-malie-garden', name: 'Guzma (Malie Garden)', segment: 'Pre-Sophocles' },
  { key: 'boss-hau-malie-city', name: 'Hau (Malie City)', segment: 'Pre-Sophocles' },
  ...
  // Pre-Vast Poni
  { key: 'boss-gladion-aether-house', name: 'Gladion (Aether House)', segment: 'Pre-Vast Poni' },
  { key: 'boss-guzma-shady-house', name: 'Guzma (Shady House)', segment: 'Pre-Vast Poni' },
  ...
  // Pre-Elite Four
  { key: 'boss-gladion-mount-lanakila', name: 'Gladion (Mount Lanakila)', segment: 'Pre-Elite Four' },
  { key: 'boss-hau-mount-lanakila', name: 'Hau (Mount Lanakila)', segment: 'Pre-Elite Four' },
  { key: 'boss-lusamine-aether-paradise', name: 'Lusamine (Aether Paradise)', segment: 'Pre-Elite Four' },
...
const ULTRA_SUN_ULTRA_MOON_ROUTES: GameLocation[] = [
  // Pre-Ilima
  { key: 'boss-hau-iki-town-usum', name: 'Hau (Iki Town)', segment: 'Pre-Ilima' },
  ...
  { key: 'boss-hau-route-3-usum', name: 'Hau (Route 3)', segment: 'Pre-Ilima' },
  ...
  { key: 'boss-hala-kahuna', name: 'Hala (Kahuna)', segment: 'Pre-Hala' },
  // Pre-Lana
  { key: 'boss-hau-paniola-town-usum', name: 'Hau (Paniola Town)', segment: 'Pre-Lana' },
  ...
  { key: 'boss-mallow-trial', name: 'Mallow (Trial)', segment: 'Pre-Mallow' },
  // Pre-Olivia
  { key: 'boss-gladion-route-5-usum', name: 'Gladion (Route 5)', segment: 'Pre-Olivia' },
  ...
  { key: 'boss-olivia-kahuna', name: 'Olivia (Kahuna)', segment: 'Pre-Olivia' },
  // Pre-Sophocles
  { key: 'boss-guzma-malie-garden-usum', name: 'Guzma (Malie Garden)', segment: 'Pre-Sophocles' },
  { key: 'boss-hau-malie-city-usum', name: 'Hau (Malie City)', segment: 'Pre-Sophocles' },
  ...
  { key: 'boss-acerola-trial', name: 'Acerola (Trial)', segment: 'Pre-Acerola' },
  // Pre-Vast Poni
  { key: 'boss-gladion-aether-house-usum', name: 'Gladion (Aether House)', segment: 'Pre-Vast Poni' },
  { key: 'boss-guzma-shady-house-usum', name: 'Guzma (Shady House)', segment: 'Pre-Vast Poni' },
  ...
  { key: 'boss-lusamine-aether-paradise', name: 'Lusamine (Aether Paradise)', segment: 'Pre-Vast Poni' },
  { key: 'boss-nanu-kahuna', name: 'Nanu (Kahuna)', segment: 'Pre-Vast Poni' },
  ...
  { key: 'boss-hapu-kahuna', name: 'Hapu (Kahuna)', segment: 'Pre-Vast Poni' },
  { key: 'boss-ultra-necrozma', name: 'Ultra Necrozma', segment: 'Pre-Vast Poni' },
  // Pre-Elite Four
  { key: 'boss-gladion-mount-lanakila-usum', name: 'Gladion (Mount Lanakila)', segment: 'Pre-Elite Four' },
  { key: 'boss-hau-mount-lanakila-usum', name: 'Hau (Mount Lanakila)', segment: 'Pre-Elite Four' },
...
const SWORD_SHIELD_ROUTES: GameLocation[] = [
  // Pre-Milo
  { key: 'boss-hop-route-1', name: 'Hop (Route 1)', segment: 'Pre-Milo' },
  { key: 'boss-hop-wedgehurst', name: 'Hop (Wedgehurst)', segment: 'Pre-Milo' },
  ...
  // Pre-Nessa
  { key: 'boss-hop-route-3', name: 'Hop (Route 3)', segment: 'Pre-Nessa' },
  ...
  // Pre-Kabu
  { key: 'boss-bede-route-5', name: 'Bede (Route 5)', segment: 'Pre-Kabu' },
  { key: 'boss-hop-route-5', name: 'Hop (Route 5)', segment: 'Pre-Kabu' },
  { key: 'boss-marnie-route-5', name: 'Marnie (Route 5)', segment: 'Pre-Kabu' },
  ...
  // Pre-Bea/Allister
  { key: 'boss-hop-stow-on-side', name: 'Hop (Stow-on-Side)', segment: 'Pre-Bea/Allister' },
  { key: 'boss-bede-stow-on-side', name: 'Bede (Stow-on-Side)', segment: 'Pre-Bea/Allister' },
  ...
  // Pre-Gordie/Melony
  { key: 'boss-bede-ballonlea', name: 'Bede (Ballonlea)', segment: 'Pre-Gordie/Melony' },
  { key: 'boss-hop-circhester', name: 'Hop (Circhester)', segment: 'Pre-Gordie/Melony' },
  ...
  { key: 'boss-marnie-spikemuth', name: 'Marnie (Spikemuth)', segment: 'Pre-Piers' },
  { key: 'boss-piers', name: 'Piers', segment: 'Pre-Piers' },
  // Pre-Raihan
  { key: 'boss-hop-route-10', name: 'Hop (Route 10)', segment: 'Pre-Raihan' },
  ...
  { key: 'boss-oleana-rose-tower', name: 'Oleana (Rose Tower)', segment: 'Pre-Champion Cup' },
  { key: 'boss-chairman-rose-energy-plant', name: 'Chairman Rose (Energy Plant)', segment: 'Pre-Champion Cup' },
...
const BRILLIANT_DIAMOND_SHINING_PEARL_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-barry-pastoria-city', name: 'Barry (Pastoria City)', segment: 'Pre-Fantina' },
  { key: 'boss-fantina', name: 'Fantina', segment: 'Pre-Fantina' },
  // Pre-Byron
...
const LEGENDS_ARCEUS_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-volo-temple-of-sinnoh', name: 'Volo (Temple of Sinnoh)', segment: 'Pre-Dialga/Palkia' },
  { key: 'boss-giratina-after-volo', name: 'Giratina (After Volo)', segment: 'Pre-Dialga/Palkia' },
];
...
const SCARLET_VIOLET_ROUTES: GameLocation[] = [
  ...
  { key: 'boss-arven-poco-path', name: 'Arven (Poco Path)', segment: 'Pre-Katy' },
  ...
  { key: 'boss-arven-area-zero', name: 'Arven (Area Zero)', segment: 'Pre-Elite Four' },
  ...
  { key: 'boss-ai-sada-area-zero', name: 'AI Sada (Area Zero)', segment: 'Pre-Elite Four' },
  { key: 'boss-ai-turo-area-zero', name: 'AI Turo (Area Zero)', segment: 'Pre-Elite Four' },
];
