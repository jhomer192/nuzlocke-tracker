...
export const GAME_ROUTES: Record<Game, GameLocation[]> = {
  ...
  EMERALD: EMERALD_ROUTES,
  FIRERED_LEAFGREEN: FIRERED_LEAFGREEN_ROUTES,
  DIAMOND_PEARL: DIAMOND_PEARL_ROUTES,
  PLATINUM: PLATINUM_ROUTES,
  HEARTGOLD_SOULSILVER: HEARTGOLD_SOULSILVER_ROUTES,
  BLACK_WHITE: BLACK_WHITE_ROUTES,
  BLACK2_WHITE2: BLACK2_WHITE2_ROUTES,
  X_Y: X_Y_ROUTES,
  OMEGA_RUBY_ALPHA_SAPPHIRE: OMEGA_RUBY_ALPHA_SAPPHIRE_ROUTES,
  SUN_MOON: SUN_MOON_ROUTES,
  ULTRA_SUN_ULTRA_MOON: ULTRA_SUN_ULTRA_MOON_ROUTES,
  SWORD_SHIELD: SWORD_SHIELD_ROUTES,
  BRILLIANT_DIAMOND_SHINING_PEARL: BRILLIANT_DIAMOND_SHINING_PEARL_ROUTES,
  LEGENDS_ARCEUS: LEGENDS_ARCEUS_ROUTES,
  SCARLET_VIOLET: SCARLET_VIOLET_ROUTES,
};
