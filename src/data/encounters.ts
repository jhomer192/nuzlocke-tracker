...
export const ENCOUNTER_TABLES: Record<string, Record<string, number[]>> = {
  ...
  LEGENDS_ARCEUS: {
    // Starter
    'gift-starter': [722, 155, 501],                      // Rowlet, Cyndaquil, Oshawott
  ...
  SCARLET_VIOLET: {
    // Starter
    'gift-starter': [906, 909, 912],                      // Sprigatito, Fuecoco, Quaxly
    // Pre-Katy
    'sv-los-platos': [19, 194, 396, 661, 819, 915],      // Rattata, Wooper(P), Starly, Fletchling, Skwovet, Flittle
